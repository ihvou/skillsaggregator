...
values
  ('00000000-0000-4000-8000-000000000001', 'forehand-clear', 'Forehand clear', 'Send the shuttle deep from the rear court with a relaxed overhead action.'),
  ('00000000-0000-4000-8000-000000000001', 'backhand-clear', 'Backhand clear', 'Recover from pressure with a compact backhand clear toward the rear court.'),
  ('00000000-0000-4000-8000-000000000001', 'forehand-smash', 'Forehand smash', 'Generate steep power from rotation, timing, contact point, and follow-through.'),
  ('00000000-0000-4000-8000-000000000001', 'backhand-smash', 'Backhand smash', 'Use a short backhand action to attack from awkward rear-court positions.'),
  ('00000000-0000-4000-8000-000000000001', 'drop-shot', 'Drop shot', 'Disguise soft overhead shots that pull opponents into the front court.'),
  ('00000000-0000-4000-8000-000000000001', 'net-shot', 'Net shot', 'Control tight spinning replies close to the tape.'),
  ('00000000-0000-4000-8000-000000000001', 'drive', 'Drive', 'Play fast flat exchanges through the mid-court with compact preparation.'),
  ('00000000-0000-4000-8000-000000000001', 'lift', 'Lift', 'Lift from the front court to reset rallies or move opponents backward.'),
  ('00000000-0000-4000-8000-000000000001', 'push', 'Push', 'Push the shuttle into open mid-court spaces with quick racket preparation.'),
  ('00000000-0000-4000-8000-000000000001', 'serve-high', 'Serve (high)', 'Use a high serve to start singles rallies with depth and height.'),
  ('00000000-0000-4000-8000-000000000001', 'serve-low', 'Serve (low)', 'Keep low serves tight and legal for doubles and singles pressure.'),
  ('00000000-0000-4000-8000-000000000001', 'footwork-front-court', 'Footwork (front court)', 'Move efficiently into lunges and recover from front-court shots.'),
  ('00000000-0000-4000-8000-000000000001', 'footwork-rear-court', 'Footwork (rear court)', 'Reach rear-court corners with chasse, scissor, and recovery steps.'),
  ('00000000-0000-4000-8000-000000000001', 'footwork-split-step', 'Footwork (split step)', 'Time the split step to react explosively to the opponent''s hit.'),
  ('00000000-0000-4000-8000-000000000001', 'defense-block', 'Defense (block)', 'Absorb smashes and guide controlled blocks into the front court.'),
  ('00000000-0000-4000-8000-000000000001', 'defense-lift', 'Defense (lift)', 'Defend hard attacks by lifting high and deep under pressure.'),
  ('00000000-0000-4000-8000-000000000001', 'singles-strategy', 'Singles strategy', 'Construct rallies with space, patience, tempo, and recovery position.'),
  ('00000000-0000-4000-8000-000000000001', 'doubles-rotation', 'Doubles rotation', 'Coordinate attack, defense, and side-by-side rotations with a partner.'),
  ('00000000-0000-4000-8000-000000000001', 'grip-technique', 'Grip technique', 'Switch between forehand, backhand, bevel, and panhandle grips cleanly.'),
  ('00000000-0000-4000-8000-000000000001', 'wrist-rotation', 'Wrist rotation', 'Use forearm and wrist rotation for deception, speed, and control.'),
  ('00000000-0000-4000-8000-000000000001', 'stringing-and-tension', 'Stringing and tension', 'Understand string choice and tension tradeoffs for feel, control, and power.')
